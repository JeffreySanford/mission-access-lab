...
- [ ] `OpenFgaAuthorizationAdapterTest` — mock `RestClient`: allow, deny, OpenFGA 5xx, OpenFGA timeout, malformed response body, demo-mode fallback when store/model unset.
